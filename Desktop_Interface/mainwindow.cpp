...
//    }
    ...
    freqRespMinXSpinbox->setMinimum(0);
    freqRespMinXSpinbox->setMaximum(62500);
    freqRespMaxXSpinbox->setMinimum(0);
    freqRespMaxXSpinbox->setMaximum(62500);
    freqRespMaxXSpinbox->setValue(62500);
    ...
    freqRespStepSpinbox->setMinimum(0);
...
void MainWindow::on_actionFrequency_Spectrum_triggered(bool checked)
{
    ...
    ui->controller_iso->hideCH2(checked);
