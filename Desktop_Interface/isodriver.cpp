    ...
    if(XYmode){
        ...
        if (spectrum) { /*If frequency spectrum mode*/
            ...
            if(m_freqRespType == 0)
            {
                ...
                axes->xAxis->setRange(*std::min_element(m_freqRespFreq.constBegin(), m_freqRespFreq.constEnd())-10, *std::max_element(m_freqRespFreq.constBegin(), m_freqRespFreq.constEnd())+10);
